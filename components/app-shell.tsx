...
export function AppShell({ children }: { children: React.ReactNode }) {
  return (
    <main className="min-h-screen p-6 md:p-10">
      <div className="mx-auto grid w-full max-w-[1080px] grid-cols-[230px_1fr] gap-4 rounded-[32px] bg-[var(--bg-surface)] p-4 shadow-[0_20px_80px_rgba(0,0,0,0.13)]">
        <aside className="flex min-h-[820px] flex-col rounded-[24px] bg-[var(--sidebar)] p-5">
          ...
          <Link href="/content" className="mt-auto rounded-xl border border-white/20 px-3 py-3 text-sm text-white/90 hover:bg-white/10">
            Contentbibliotheek
          </Link>
        </aside>
